  ...
  return (
    <div className="min-h-screen bg-[#9E9E9E] text-white">
      ...
      <div className="flex">
        ...
        <div
          className={`fixed left-0 top-0 h-full bg-gradient-to-b from-[#1f2937] to-[#1f2937] text-white w-72 transform transition-transform duration-300 ease-in-out shadow-xl z-50 overflow-y-auto ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
            } rounded-r-lg pt-5 pd-5`}
        >
          {/* Close Button */}
        ...
        <button
          onClick={toggleSidebar}
          className="fixed left-4 top-4 z-40 bg-[#] text-white p-3 rounded-full shadow-md transition-transform duration-300 ease-in-out hover:scale-110 focus:outline-none"
        >
          <Menu size={24} />
        </button>
