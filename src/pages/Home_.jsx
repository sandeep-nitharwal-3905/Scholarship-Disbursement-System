...
const PMSSSPortal = () => {
  ...
  // Sidebar section component to reduce repetition
...
<div className="min-h-screen bg-[#9E9E9E] text-white">
  ...
  <header className="bg-gradient-to-b from-[#3E3E3E] to-[#3E3E3E] text-white">
    {/* Navigation Bar 1 */}
    ...
    {/* Navigation Bar 2 */}
    <nav className="bg-[#0F9D58] py-3">
      <div className="container mx-auto flex justify-center space-x-6">
        <a
          href="/home"
          className="flex items-center text-white hover:text-[#FFC107]"
        >
  ...
  <div className="flex">
    ...
    <div
      className={`fixed left-0 top-0 h-full bg-gradient-to-b from-[#3A3B3C] to-[#3A3B3C] text-white w-72 transform transition-transform duration-300 ease-in-out shadow-xl z-50 overflow-y-auto ${
    ...
    >
      ...
      <div className="absolute top-4 right-4">
        <X
          className="cursor-pointer text-white hover:text-[#B2B7BF] transition-colors duration-200"
          size={24}
    ...
    <button
      onClick={toggleSidebar}
      className="fixed left-4 top-4 z-40 bg-[#B2B7BF] text-white p-3 rounded-full shadow-md transition-transform duration-300 ease-in-out hover:scale-110 focus:outline-none"
    >
      <Menu size={24} />
    </button>

        {/* Main Content Area */}
        <main className="flex-grow p-8 ml-0 md:ml-16 transition-all duration-300">
